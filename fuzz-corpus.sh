...
cat /dev/urandom | head -c 16 | xxd -ps -c 16 > "$PWD/corpus/8" 
cat /dev/urandom | head -c 1024 | xxd -ps -c 64 > "$PWD/corpus/9" 
cat /dev/urandom | head -c 65536 | xxd -ps -c 65536> "$PWD/corpus/10" 
cat /dev/urandom | head -c 524288 | xxd -ps -c 1024 > "$PWD/corpus/11" 
